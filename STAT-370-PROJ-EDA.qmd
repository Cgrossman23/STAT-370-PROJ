...
```{r}
ggplot(EDA_filtered2, aes(x = cost_small, fill = plant_type)) +
...
ggmap(basemap) +
  geom_point(data = EDA_a, aes(x = longitude, y = latitude, color = exposure), size = 2) +
  scale_color_manual(values = c("Exposed" = "red", "Unexposed" = "blue")) +
  theme_minimal() +
  ggtitle("Site A: Exposure groups")

ggmap(basemap) +
  geom_point(data = EDA_a, aes(x = longitude, y = latitude, color = plant_type), size = 2) +
...
ggmap(basemap) +
  geom_point(data = EDA_b, aes(x = longitude, y = latitude, color = exposure), size = 2) +
  scale_color_manual(values = c("Exposed" = "red", "Unexposed" = "blue")) +
  theme_minimal() +
  ggtitle("Site B: Exposure groups")

ggmap(basemap) +
  geom_point(data = EDA_b, aes(x = longitude, y = latitude, color = plant_type), size = 2) +
  scale_color_manual(values = c("sch" = "red", "typ" = "blue")) +
  theme_minimal() +
