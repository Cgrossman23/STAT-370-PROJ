...
```{r}
model_zero_a <- zeroinfl(density ~ water_depth , data = wave_a, dist="poisson")
...
AIC(model_zero_a, poisson_model_b)
BIC(model_zero_a, poisson_model_b)
...
```{r}
model_zero_b <- zeroinfl(density ~ water_depth , data = wave_b, dist="poisson")

summary(model_zero_b)

poisson_model_b <- glm(density ~ water_depth, family = poisson, data = wave_b)
vuong(model_zero_b, poisson_model_b)
...
```{r}
model_zero_c <- zeroinfl(density ~ water_depth , data = wave_c, dist="poisson")

summary(model_zero_c)

poisson_model_c <- glm(density ~ water_depth , family = poisson, data = wave_c)
vuong(model_zero_c, poisson_model_c)

AIC(model_zero_c, poisson_model_c)
BIC(model_zero_c, poisson_model_c)
...
```{r}
model_zero_d <- zeroinfl(density ~ water_depth , data = wave_d, dist="poisson")

summary(model_zero_d)

poisson_model_d <- glm(density ~ water_depth, family = poisson, data = wave_d)
vuong(model_zero_d, poisson_model_d)

AIC(model_zero_d, poisson_model_d)
BIC(model_zero_d, poisson_model_d)
